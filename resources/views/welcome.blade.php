                ...
                <div class="row align-items-center padding-y">
                    <div class="col-lg-5 col-xl-4 text-center text-lg-start">
                        ...
                        <div class="py-4 text-center  rounded mb-0 text-white bg-process-img">
                            <h1 class="h2 text-center text-lg-start text-primary font-vintage mb-0">Get More Enjoyment From Your Vacation Home
                            </h1>
                        </div>
                        <div>
                            <h1 class="poppins-bold pt-2">What is the Vacation Calendar?</h1>
                            <p class="pe-0 pe-lg-4 lh-lg text-light-secondary">The Vacation Calendar is a shared online calendar for families that share a vacation home. Alternatively, if you love having visitors and want to let your friends and family know when there is a good time to come visit, the calendar allows you to share when visitors are coming.

                                The application is also a single point for both important information about your vacation home as well as a great place to share the wonderful experiences everyone has enjoyed when visiting.

                                The main feature is a calendar that allows certain users the ability to specify when they are using the home. But don’t worry, users can only update their own vacations so you can be sure there are no shenanigans that could result in a disagreement on who is using the house. The
                                site also makes it easy for others to request to join an existing vacation or request to use your vacation house when it is not booked.

                                It doesn’t matter whether you are looking for a beach house calendar, ski house calendar, or mountain house calendar, this site works great for anybody looking for a vacation home calendar. Check out the main features below.
                            </p>
                    ...
                    <div class="col-lg-3 mt-4 mt-lg-0 offset-lg-1 offset-xl-2 d-none d-lg-block">
                        ...
                        <div
                            ...
                            <div class="card-body pt-5 padding-top">
                                ...
                                <p class="card-text">Let friends and family see when there are good times to visit or let them see when the house is not being used so your vacation home is used and enjoyed more.
                                </p>
                    ...
                    <div class="col-lg-3 d-none d-lg-block">
                        <div class="card  border-0 my-4 my-lg-0 rounded-3 bg-card-2 margin-y text-center text-lg-start">
                            ...
                            <div class="card-body pt-5 padding-top">
                                <h3 class="card-title">Share information with the house bulletin board, local guide and food lists</h3>
                                <p class="card-text">Direct all of your guests to a single location that has all of the information about the house and the surrounding area.
                                </p>
                        ...
                        <div class="card  border-0 mt-3 mt-md-5 rounded-3 bg-card-3 text-center text-lg-start">
                            ...
                            <div class="card-body pt-5 padding-top">
                                <h3 class="card-title">Save and share memories of all the enjoyment your vacation home brings</h3>
                                <p class="card-text">Users can upload photos to the online photo album, share experiences with house blog entries and even say thank you with the new guest book.</p>
                    ...
                    <div class="col-lg-4 my-4 my-lg-0">
                        ...
                        <div class="card p-2 text-center text-lg-start">
                            ...
                            <div class="card-body">
                                ...
                                <div style="height: 200px">
                                   <p class="card-text text-light-secondary">One of the most popular features (that just got a whole lot better!) is the photo album. Users can upload photos to the
                                    album to memorialize the great times. Photos can be put into albums to keep things nice and organized.</p>
                                </div>
                                <div>
                                    <a href="{{ route('guest.help') }}" class="btn btn-lg w-100 btn-primary text-white">Learn
                                        More <i
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card p-2 text-center text-lg-start">
                            ...
                            <div class="card-body">
                                ...
                                <div style="height:200px">
                                    <p class="card-text text-light-secondary">How have you ever lived without a blog for your vacation home?!?! The House Blog gives everyone a place to share thoughts and provide updates. Other users can “like” the blog entry and add comments.
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card p-2 text-center text-lg-start">
                            ...
                            <div class="card-body">
                                ...
                                <div style="height: 200px">
                                    <p class="card-text text-light-secondary">This brand new feature allows users to create a guide book of any and everything to do, see, eat, etc. in the area.
                                        Each guide book item has space for lots of information and is connected to Google Maps. Best of all, your users can add ratings so everyone will know the best places around.
                                    </p>
                                </div>
                                <div>
                                    <a href="{{ route('guest.help') }}" class="btn btn-lg w-100 btn-primary text-white">Learn
                    ...
                    <div class="col-lg-4 my-4 my-lg-0">
                        ...
                        <div class="card p-2 text-center text-lg-start">
                            ...
                            <div class="card-body">
                                ...
                                <div style="height: 200px">
                                    <p class="card-text text-light-secondary">Yes, another new feature in 2022! Inspired by Dave Navarro who had every guest in house step into his home photo booth.
                                        The thought behind this feature was that families could ask each of their guests to leave a note in the Guest Book after a stay. Over time you would have a fun reminder of all the people who visited and enjoyed your vacation home.</p>
                                </div>
                                <div>
                                    <a href="{{ route('guest.help') }}" class="btn btn-lg w-100 btn-primary text-white">Learn
                                        More <i
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card p-2 text-center text-lg-start">
                            ...
                            <div class="card-body">
                                ...
                                <div style="height: 200px">
                                    <p class="card-text text-light-secondary">Tracking food in the house can be helpful especially if you plan on bringing food to your house.
                                        These lists help everyone know what food is already at the house and what needs to be picked up.</p>
                                </div>
                                <div>
                                    <a href="{{ route('guest.help') }}" class="btn btn-lg w-100 btn-primary text-white">Learn
                                        More <i
            ...
            <div class="container mt-2 mt-sm-0">
                <div class="row align-items-center min-height">
                    ...
                    <div class="col-lg-5">
                        ...
                        <h1 class="mb-0 h2 text-center text-lg-start font-vintage text-primary">Customize Your Vacation Home
                        </h1>
                    </div>
                    <div>
                        {{--          nav tabs           --}}
                        <div class="images-nav-tabs  mt-3 mt-md-2 mt-lg-1 row"><!-- tab content -->
                            <div
                                ...
                                <div class="tab-pane fade show active" id="guest-user" role="tabpanel"
                                    ...
                                    <p class="lh-lg text-light-secondary">The Guest User is a single password that you can share with anyone that you want to be able to see your vacation home site,
                                        but don’t want them to have the ability to schedule vacations. These users are able to click on an existing
                                        vacation and request to join that vacation or they can click on a day on the calendar
                                        when there isn’t a scheduled vacation and they can request to use the vacation home. </p>
                                </div>
                                <div class="tab-pane fade" id="management" role="tabpanel" aria-labelledby="management-tab">
                                    ...
                                    <p class="lh-lg mb-1 text-light-secondary">One of the most important administrative functions is managing who can access your site
                                        and what permissions they have. You can create additional Administrators and Owners. This is also where you can reset your users passwords if they are having trouble logging in and you can disable users
                                        who you no longer want to have access to the site</p>

                                </div>
                                <div class="tab-pane fade" id="notifications" role="tabpanel" aria-labelledby="notifications-tab">
                                    <h1 class="poppins-bold">Notifications</h1>
                                    <p class="lh-lg text-light-secondary">Since most users don’t log into TheVacationCalendar.com on a daily basis, we needed a way so that families can stay aware of what is happening on the calendar.
                                        An Administrator can add email addresses of the individuals who want to be made aware of certain events on the site. The most common is getting notified any time
                                        a vacation is scheduled, updated or deleted. This way no one finds out that the summer has already been fully scheduled before they have a chance to take a look and plan their visit.
                                    </p>
                                </div>
                                <div class="tab-pane fade" id="history" role="tabpanel" aria-labelledby="history-tab">
                                    <h1 class="poppins-bold">Audit History
                                    </h1>
                                    <p class="lh-lg text-light-secondary">This new and powerful feature gives the Administrator all the information
                                        they can handle about who is using the site and what they are doing. Did someone say they created a vacation for 10 days but the
                                        calendar only shows 8 days? The audit history will give you the who, what and when for almost any change to the site.</p>
                                </div>
                                <div class="tab-pane fade" id="houses" role="tabpanel" aria-labelledby="houses-tab">
                                    <h1 class="poppins-bold">Multiple Houses
                                    </h1>
                                    <p class="lh-lg text-light-secondary">This was one of the most common feature requests over the last few years.
                                        Turns out there are a lot of people looking for a single place to manage the beach house calendar and ski house calendar.
                                        Or maybe you need to manage multiple cabins or want a separate guest house calendar.
                                        You can now add multiple properties to your site so that you can manage everything with a single account. Best of all,
                                        you can look for availability across all the houses from one consolidated calendar view.</p>
                                </div>
                                <div class="tab-pane fade" id="rooms" role="tabpanel" aria-labelledby="rooms-tab">
                                    <h1 class="poppins-bold">Booking Rooms
                                    </h1>
                                    <p class="lh-lg text-light-secondary">Several years ago, we removed the ability to allow users to book specific rooms in their house.
                                        Turns out this attempt to simplify the site did not go over well. To make matters worse, a publication that wrote a story about
                                        TheVacationCalendar.com highlighted the booking rooms functionality so new users regularly requested that it come back. Well wait
                                        no more! You can specify what rooms your house has for sleeping, the number of people
                                        that can sleep in each room, and then mark rooms as occupied for different periods within a vacation. </p>
                                </div>
                                <div class="tab-pane fade" id="subscription" role="tabpanel" aria-labelledby="subscription-tab">
                                    <h1 class="poppins-bold">Subscription Management
                                    </h1>
                                    <p class="lh-lg text-light-secondary">With all of this new functionality comes some changes in our pricing including more flexibility.
                                        The original $20 a year price had not changed in 16 years because it covered the costs of operating the site. We went to an outside
                                        firm to build and support the new site and all the new features so our pricing needed to change. You can now pay monthly or annually
                                        and you can choose between three tiers of pricing depending on which features you need. </p>
                                </div>
                                <div class="tab-pane fade" id="account" role="tabpanel" aria-labelledby="account-tab">
                                    <h1 class="poppins-bold">Account Management
                                    </h1>
                                    <p class="lh-lg text-light-secondary">Believe it or not, but there are even more ways to customize TheVacationCalendar.com
                                        that have not been covered in this dense page of information. The Account Management page is a catch all
                                        to add some fine tuning to what users can and can’t see as well as manage your own email and password. Don’t forget to update
                                        your profile picture so your desired image shows up on your vacation dates and various posts! </p>
                                </div>
                            </div>
                            <!-- tab content ends -->
                            <ul class="col-12 order-1 order-lg-2 mb-4 mb-lg-0 nav nav-tabs border-bottom-0 d-flex justify-content-center justify-content-lg-start mt-2 padding-0"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="guest-user" data-bs-toggle="tab"
                                            data-bs-target="#guest-user" role="tab" aria-controls="guest-user" aria-selected="true">
