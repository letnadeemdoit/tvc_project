            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 mt-4 mt-lg-0 offset-lg-2">
                        ...
                        <div class="card text-center text-lg-start border-0 rounded-3 bg-card-1 me-0 me-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="card text-center text-lg-start border-0 my-4 my-lg-0 rounded-3 bg-card-2">
                        ...
                        <div class="card text-center text-lg-start border-0 mt-2 rounded-3 bg-card-3">
                            <div class="d-block d-lg-flex text-center justify-content-center justify-content-lg-start w-100 align-items-center h-100 position-absolute">
                                <div class="bg-white rounded-pill p-4 rounded-icon">
