...
<div>
    ...
    <main>
        ...
        <section class="working-section">
            <div class="container">
                <div class="row text-center pt-5">
                    <div class="col-12">
                        <p class="font-garamond orange-color fs-3">Working</p>
                        <p class="fs-1 font-jost">How we help you</p>
                    </div>
                </div>
        ...
        <!-- section 2 -->
        <section class="vacation-calendar section-margin">
            <div class="container">
        ...
        <section class="managing-vacations  position-relative margin-top img-index py-4 pb-xxl-0">
            <div class="container">
        ...
        <section class="calendar-section-2 mt-5">
            <div class="container">
