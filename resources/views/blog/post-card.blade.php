<div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-3">
        <div class="card blog-card">
            <div class="w-100">
                ...
                <a href="{{route('guest.blog-details', $post->BlogId)}}">
                    <img src="{{ $post->getFileUrl() }}" class="card-img-top  position-relative" style="height: 290px !important;object-fit: cover" alt="..." />
                </a>
            </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="user-img d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                ...
                                <p><small>{{\Carbon\Carbon::parse($post->BlogDate)->format('d M Y')}}</small></p>
                            </div>
                        </div>
