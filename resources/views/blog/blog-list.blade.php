<div class="container pt-5">
    <div class="row my-5  category-cards">
        <div class="col-12">
            <ul class="nav nav-tabs border-bottom-0 blog-tabs d-flex justify-content-center justify-content-lg-start"
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        <img src="/images/blog-images/tiny-house.svg" width="30px"
                             class="me-2 d-none d-md-inline-block"/>TINY
                        HOUSE
                    </a>
                </li>
                <li class="nav-item">
