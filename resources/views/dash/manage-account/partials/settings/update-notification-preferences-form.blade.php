<div id="notificationsSection" class="card">
    ...
    <form wire:submit.prevent="updateNotificationPreferences" class="card-body">
        <div class="mb-3">
            <label class="form-label" for="calendar_email_list">Send email when  calendar changes:</label>
            <textarea
        ...
        <div class="mb-3">
            <label class="form-label" for="blog_email_list">Send email when new blog items are added:</label>
            <textarea
                id="blog_email_list"
