<div id="passwordSection" class="card">
    ...
    <div class="card-body">
        <!-- Form -->
        <form id="changePasswordForm" wire:submit.prevent="changePassword">
            <!-- Form -->
            <div class="row mb-4">
                <label for="current_password" class="col-sm-3 col-form-label form-label">Current password</label>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <x-jet-action-message on="saved" class="text-muted">Your password changed successfully.</x-jet-action-message>
