<x-email-layout>
        ...
        <tr>
            <td style="padding: 20px;">
                    <span
                      ...
                      "
                    >
                    Request to Join {{$vacation_name}} at {{$createdHouseName}}
                </span>
            </td>
        </tr>
        </tbody>
    ...
    <p class="body-text">
        {{$owner['name']}} has requested to join your vacation, {{$vacation_name}} from {{$startDate . ' to ' . $endDate}}.
    </p>
    <!-- House Info Section -->
    <div class="body-address-box">
        <table class="address-table" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="value-column"><span class="body-text-color">{{$vacation_name}}</span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="value-column">
                    ...
                    (<span class="email-text-color">{{$owner['email']}}</span>)
                </td>
            </tr>
            </tbody>
        </table>
    ...
    <p class="body-text">
        Please confirm directly with the requestor if they are able to join this vacation.
    </p>
