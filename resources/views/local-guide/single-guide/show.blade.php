                        ...
                        <div class="flex-grow-1 ms-3 d-block d-sm-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div class="d-flex align-items-center ">
                                    ...
                                    <span class="ps-2">({{$localGuide->reviews()->count()}} Reviews)</span>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-9 pe-0 pe-lg-5">
                    <div class="border-bottom">
                        <p class="mb-0" style="font-size: 12px"><span class="mx-1 text-muted">{{$localGuide->created_at->diffForHumans()}}</span></p>
                    </div>
                    <div class="py-4">
