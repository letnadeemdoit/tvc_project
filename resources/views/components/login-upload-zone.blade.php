...
>
    ...
    >
        <div class="dz-message">
            ...
            <div class="text-center">
                <input
                    id="file_upload_login"
                    type="file"
                    name="image"
                    hidden="hidden"
                    x-ref="file_upload_login"
                    x-on:change.prevent="files = Array.from($el.files); validateAndPreviewImages();"
                    {{ $multiple ? 'multiple' : '' }}
                />
                <button class="btn bg-primary btn-sm text-white" onclick="event.preventDefault(); document.getElementById('file_upload_login').value = null; document.getElementById('file_upload_login').click(); ">Upload Image</button>
            </div>
        </div>
