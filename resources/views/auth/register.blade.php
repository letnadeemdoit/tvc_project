            ...
            <form class="js-validate needs-validation" novalidate action="{{ route('register') }}">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-2">
                                ...
                                <input class="form-control form-control-lg" type="text" id="admin_username">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-2">
                                <label for="adminpasswordconfirm" class="form-label fs-5">Admin
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg" name="name" :value="old('name')"
                                       id="name" placeholder="First Name" aria-label="Mark" required autofocus
                                       autocomplete="name">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="Last Name"
                                       aria-label="" id="lastname" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control form-control-lg" name="zipcode-2" id="zipcode-2"
                               placeholder="Enter Zip Code" aria-label="" required>
                    </div>
                    <!-- End Form -->
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-merge" data-hs-validation-validate-class>
                            <input type="number" class="js-toggle-password form-control form-control-lg"
                                   name=homephone-2 id="homephone-2" placeholder="8+ characters required"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-merge" data-hs-validation-validate-class>
                            <input type="number" class="js-toggle-password form-control form-control-lg" name="fax-2"
                                   id="fax-2" placeholder="8+ characters required" aria-label="8+ characters required"
