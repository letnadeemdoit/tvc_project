...
{{--            <h1 class="pt-2 text-center poppins-bold">Read guest reviews here</h1>--}}
                ...
                <div class="row">
                    ...
                    @foreach($data as $dt)
                        ...
                        @else
                            ...
                            {{--              modal              --}}
                            <div class="modal guest-modal fade" id="guestBook{{$dt->id}}Model" tabindex="-1"
        ...
        <div class="container padding-bottom leaveReviewSection" style="padding-top: 80px">
                ...
                <div class="modal-dialog modal-dialog-centered">
                  ...
                  <span class="rounded-circle text-primary border-primary" style="padding: 4px 9px; font-size: 26px; line-height: 75px;border: 3px solid;">
                    <i class="bi-check-lg"></i>
                            ...
                            <p class="fw-500 fs-15">Guest Book will appear after it is approved by the house administrator!
                            </p>
