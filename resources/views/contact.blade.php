<x-guest-layout>
    <!-- Hero -->
    <div class="position-relative bg-img-start" style="background-image: url({{ asset('img/svg/hero-bg.svg') }});">
        <div class="container content-space-t-2 content-space-t-lg-2 content-space-b-2 position-relative zi-2">
            <div class="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
                <h1 class="display-3">Contact us</h1>
                <p class="fs-3">We'd love to talk about how we can help you.</p>
            </div>

            <div class="row">
                <div class="col-md-4 mb-3 mb-md-0">
                    <!-- Card -->
                    <a class="card card-transition text-center h-100 py-5 shadow-lg" href="#">
                        <div class="card-body">
                            ...
                            <h4 class="card-title display-5">Knowledgebase</h4>
                            <p class="card-text text-body fs-4">We're here to help with any questions or code.</p>
                        </div>
                ...
                <div class="col-md-4 mb-3 mb-md-0">
                    ...
                    <a class="card card-transition text-center h-100 py-5 shadow-lg" href="#">
                        <div class="card-body">
                            ...
                            <h4 class="card-title display-5">FAQ</h4>
                            <p class="card-text text-body fs-4">Search our FAQ for answers to anything you might ask.</p>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <a class="card card-transition text-center h-100 py-5 shadow-lg" href="#">
                        <div class="card-body">
                            ...
                            <h4 class="card-title display-5">Developer APIs</h4>
                            <p class="card-text text-body fs-4">Check out our development quickstart guide.</p>
                        </div>
            ...
            <div class="card shadow-lg">
                <div class="card-body p-6">
                    ...
                    <div class="text-center mb-5 mb-md-9">
                        <h2 class="display-5">Tell us about yourself</h2>
    ...
    <div class="container-fluid mb-10 p-0">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d109132.50717458608!2d72.21911081640624!3d31.265282300000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3923a3d944211f27%3A0xfe1509a2f8d6f2a5!2stravelforbes!5e0!3m2!1sen!2s!4v1655819155305!5m2!1sen!2s" class="w-100" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    <!-- End Leaflet -->
</x-guest-layout>
