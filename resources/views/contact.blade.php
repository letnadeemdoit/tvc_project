                    ...
                    <div class="card shadow-lg">
                        <div class="card-body p-6">
                            ...
                            <form action="{{route('guest.contact.mail')}}" method="post" id="contactForm">
                                ...
                                <div class="gap-3 text-center mt-4 d-block d-md-flex justify-content-center">
                ...
                <div class="col-lg-6 mt-3 mt-lg-0">
                    <div class="card h-100 ">
                        <div class="card-body p-2 p-md-3 d-flex justify-content-center align-items-center">
                            <img class="img-fluid"
                                 src="{{ asset('images/images-home/contact-us.jpg') }}"
