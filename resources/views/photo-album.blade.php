            ...
            <div class="row masonary-gallery" data-masonry='{"percentPosition": true }'>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card border-0 text-white bg-transparent shadow-none">
                            ...
                            <img
                                src="{{asset('https://images.unsplash.com/photo-1660679867941-2f2d560d008f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80')}}"
                                class="card-img"/>
                            {{--                        </a>--}}
                            <div class="p-0">
                                <div
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card border-0 text-white bg-transparent shadow-none">
                            ...
                            <img
                                src="{{asset('https://images.unsplash.com/photo-1660655641795-8a68ca5da6c5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw1NXx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60')}}"
                                class="card-img"/>
                            {{--                        </a>--}}
                            <div class="p-0">
                                <div
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card border-0 text-white bg-transparent shadow-none">
                            ...
                            <img
                                src="{{asset('https://images.unsplash.com/photo-1660659236367-710aa4ae7e19?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw2MHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60')}}"
                                class="card-img"/>
                            {{--                        </a>--}}
                            <div class="p-0">
                                <div
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card border-0 text-white bg-transparent shadow-none">
                            ...
                            <img
                                src="{{asset('https://images.unsplash.com/photo-1660646654254-08a09f8589ef?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw4N3x8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60')}}"
                                class="card-img"/>
                            {{--                        </a>--}}
                            <div class="p-0">
                                <div
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card border-0 text-white bg-transparent shadow-none">
                            ...
                            <img
                                src="{{asset('https://images.unsplash.com/photo-1660586179082-775abddd8386?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw4M3x8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60')}}"
                                class="card-img"/>
                            {{--                        </a>--}}
                            <div class="p-0">
                                <div
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card border-0 text-white bg-transparent shadow-none">
                            ...
                            <img
                                src="{{asset('https://images.unsplash.com/photo-1660629813449-2f621228cc68?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw5N3x8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60')}}"
                                class="card-img"/>
                            {{--                        </a>--}}
                            <div class="p-0">
                                <div
                    ...
                    <div class="col-md-3 mb-4">
                        <div class="card border-0 text-white bg-transparent shadow-none">
                            ...
                            <img
                                src="{{asset('https://images.unsplash.com/photo-1660632531779-b363f16acdbd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80')}}"
                                class="card-img"/>
                            {{--                        </a>--}}
                            <div class="p-0">
                                <div
